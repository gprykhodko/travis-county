...
require([
  ...
  const habitat = new GroupLayer({
    ...
    layers: [
      warbler = new MapImageLayer({ //Golden-cheeked Warbler Habitat
      ...
      blackVireo = new MapImageLayer({ //Black-capped Vireo Habitat
        url: "https://gis.traviscountytx.gov/server1/rest/services/BCP_BCCP/Habitat_areas/MapServer",
        opacity: 0.5,
        listMode: "hide-children",
  ...
  const recycling = new GroupLayer({
    title: "Recycling",
    layers: [
      warbler = new MapImageLayer({ //Prescription Drop Off Sites (2017)
